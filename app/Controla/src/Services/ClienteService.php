...
/**
 * Cadastro da cliente: monta, valida e grava.
 *
 * Nome repetido NAO bloqueia -- duas clientes podem se chamar Maria, e quem
 * decide se e a mesma pessoa e ela, nao o sistema.
 *
 * @package Controla
...
{
    /** @var list<int> Tamanhos aceitos: fixo com DDD e celular com DDD. */
    private const DIGITOS_TELEFONE = [10, 11];

    /**
     * Cria (id null) ou atualiza uma cliente.
     *
    ...
    /**
     * Cadastro rapido feito de dentro da tela de venda, onde ela so tem o nome
     * da cliente em maos.
     *
    ...
    /**
     * A mascara da tela e descartada aqui: no banco o telefone e so digito.
     *
